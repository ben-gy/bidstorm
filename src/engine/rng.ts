 ...
 * constructs an identical RNG from it. In Bidstorm this is what lets the prize
 * order never travel the wire at all — every peer shuffles the same deck from
 * the same seed. Never use Math.random() for anything peers must agree on.
 *
