 ...
 * character typed straight into a source file (a NUL as a map-key separator, an
 * escape byte in a fixture) compiles and runs perfectly — and then:
 *
 ...
 *
 * (This test caught its own file during the build, which is the best possible
